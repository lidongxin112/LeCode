 ...
 * 给你一个 严格递增 的正整数数组 arrival ，表示第 i 个任务的到达时间，和另一个数组 load ，其中 load[i] 表示第
 * i 个请求的工作量（也就是服务器完成它所需要的时间）。你的任务是找到 最繁忙的服务器 。
...
public class lc1606 {
    ...
    public static void main(String[] args) {
        ...
        int[] load = {5, 2, 3, 3, 3};
        new lc1606().busiestServers(k, arrival, load);
    }
}
